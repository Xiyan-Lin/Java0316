...
public class BMIClass1 {
    public static void main(String[] args) {
        ...
        System.out.printf("姓名:%s , 身高:%.1d ,體重:%.1d, BMI:%.2d, 結果:%s" , name1,height1, weight1,bmi1, result1 );
        ...
        System.out.printf("姓名:%s , 身高:%.1d ,體重:%.1d, BMI:%.2d, 結果:%s" , name2,height2, weight2,bmi2, result2 );
    }
}
